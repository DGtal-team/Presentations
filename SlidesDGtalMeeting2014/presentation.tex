...
\begin{frame}%[allowframebreaks]
 ...
 \hspace*{-1cm} \begin{tabular}{cccccc}
    ...
    &
    \includegraphics[height=0.15\textheight]{xyz512}
    &
...
\begin{alertblock}{\centering Graph Package\HH}
    \footnotesize
    \begin{itemize}
    \item Concepts and adapters to process digital structures as graphs
    \end{itemize}
  \end{alertblock}
...
\item Used in couple of research projects (ANR digitalSnow, 
  collaboration with Chemical lab in Lyon -- digitalFoam--, collaboration with INRA  at Nancy,... )
\end{itemize}
