    ...
    \begin{columns}
      ...
      \begin{column}{0.44\textwidth}
        \begin{myblocklgreenish}{\textwidth}{Geometry module}
          ...
          - volumetric analysis: area/volume, distance transforms, medial axis
        \end{myblocklgreenish}
      \end{column}
    \end{columns}
  \end{myblockgreenish}
...
\begin{frame}%[allowframebreaks]
  ...
  \begin{columns}
    ...
    \begin{column}{0.32\textwidth}
      \begin{myblocklredish}{\textwidth}{2D, 3D/2D vector export (PDF,
          SVG,\ldots)}
...
\small
  \begin{block}{\scriptsize New in milestone 0.4beta (now)}
    \scriptsize
    \begin{itemize}
    \item Kernel update: refactoring of the kernel classes
    \item 2D, nD-volumetric geometry: geometric estimators, easy
      multigrid analysis
    \item 3D visualization with QGLviewer
    \item Easier use of streams for vector export (with libBoard and Cairo)
    \item grid or interpixel topology: cells, digital surfaces,
      surface tracking
    \item implicit/parametric shape factory
    \item Infrastructure: git repository and github project
      managment system, better cmake scripts
    \end{itemize}
  \end{block}

  \begin{myblockredish}{\textwidth}{\scriptsize Join DGtal}
    \scriptsize
    \begin{itemize}
...
\begin{frame}
  \frametitle{Program of the tutorial day}

  \begin{itemize}\scriptsize
  \item 9h        accueil
   \item   9h30   DGtal Overview, How to download and install     DGtal ?
  \item    Kernel Introduction (David)
   \item   10h30  Digital Domains (Guillaume)
  \item    (break)
 \item     11h00  Digital Topology \& Khalimsky spaces (Jacques-Olivier)
 \item     12h00  lunck
  \item    13h30  Streams, visualization, ... (Bertrand)
  \item    14h30  2D geometry (Tristan)
  \item    15h00  Volumetric geometry (David)
  \item    15h30  2D estimators (??)
  \item    (break)
  \item    16h00  DGtal tools  (demo,
    Bertrand / David)
  \item    16h30  Discussions
   \item   17h30  The End
  \end{itemize}
\end{frame}
